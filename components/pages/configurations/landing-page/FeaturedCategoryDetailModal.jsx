            ...
            <div className="py-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                        ...
                        <LabelAndValue label="Placement" value={currentCategory?.placementArea?.replace(/-/g, ' ')} className="capitalize" />
                    ...
                    <div className="rounded-xl border border-gray-100 bg-gray-50/50 p-5">
                        ...
                        <Form form={form} layout="vertical">
                            <SingleImageUploader
                                ...
                                label=""
                                editPage={true}
                                existingImage={currentCategory?.imageUrl ? { imageUrl: `${currentCategory.imageUrl}?v=${refreshCounter}` } : null}
                            />
                            ...
                            <Button
                                ...
                                className="w-full h-[42px] bg-green-600 hover:bg-green-700"
                            >
                                Update Image
                            </Button>
                        </Form>
