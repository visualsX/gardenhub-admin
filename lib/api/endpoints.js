export const API_ENDPOINTS = {
  ...
  LANDING_PAGE: {
    BANNERS: {
      CREATE: '/admin/landing-page/banners',
      UPDATE: (id) => `/admin/landing-page/banners/${id}`,
      DELETE: (id) => `/admin/landing-page/banners/${id}`,
      UPDATE_IMAGES: (id) => `/admin/landing-page/banners/${id}/images`,
    },
    FEATURED_CATEGORIES: {
      CREATE: '/admin/landing-page/featured-categories',
      UPDATE: (id) => `/admin/landing-page/featured-categories/${id}`,
      DELETE: (id) => `/admin/landing-page/featured-categories/${id}`,
      UPDATE_IMAGE: (id) => `/admin/landing-page/featured-categories/${id}/image`,
    },
  },
  ...
  // Payment Methods
  PAYMENT_METHODS: {
    CREATE: '/admin/PaymentMethod',
    UPDATE: (id) => `/admin/PaymentMethod/${id}`,
    DELETE: (id) => `/admin/PaymentMethod/${id}`,
  },
};
