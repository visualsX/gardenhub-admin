...
export const Customer_QUERIES = {
  ...
  query($first: Int, $after: String, $last: Int, $before: String, $where: AddressDtoFilterInput, $order: [AddressDtoSortInput!]) {
  customerAddresses(
    first: $first, after: $after, last: $last, before: $before, where: $where, order: $order
  ) {
    totalCount
    nodes {
      addressLine2
...
export const BUNDLES_QUERIES = {
  GET_BUNDLES: gql`
 query ($first: Int, $after: String, $last: Int, $before: String, $where: BundleDetailDtoFilterInput, $order: [BundleDetailDtoSortInput!]) {
  bundles(
    first: $first
    after: $after
    last: $last
...
export const SHIPPING_ZONE_QUERIES = {
 ...
 query ($first: Int, $after: String, $last: Int, $before: String, $where: ShippingZoneDtoFilterInput, $order: [ShippingZoneDtoSortInput!]) {
  shippingZones(
    first: $first
    after: $after
    last: $last
