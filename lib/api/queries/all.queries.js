...
// ===================================
export const PAYMENT_METHOD_QUERIES = {
  GET_PAYMENT_METHODS: gql`
    query (
      ...
      $last: Int
      $before: String
      $where: PaymentMethodDtoFilterInput
      $order: [PaymentMethodDtoSortInput!]
    ) {
      paymentMethods(
        first: $first
        after: $after
...
export const LANDING_PAGE_QUERIES = {
  ...
  GET_FEATURED_CATEGORIES: gql`
    query (
      ...
      $last: Int
      $before: String
      $where: FeaturedCategoryDtoFilterInput
      $order: [FeaturedCategoryDtoSortInput!]
    ) {
...
export const ORDER_QUERIES = {
  GET_ORDERS: gql`
    query (
      ...
      $last: Int
      $before: String
      $where: OrderListDtoFilterInput
      $order: [OrderListDtoSortInput!]
    ) {
      orders(
        first: $first
        after: $after
...
export const REVIEW_QUERIES = {
  GET_REVIEWS: gql`
    query (
      $status: ReviewFilterStatus! # All, PENDING, APPROVED
      $productId: Int
      $first: Int
      $after: String
      $last: Int
